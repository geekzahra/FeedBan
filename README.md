...
&rlm;فیدبان نگهبان فیدته و کمک می‌کنه فید X (توییتر) رو مرتب کنی. کافیه یه ایموجی یا عبارت بهش بدی تا اون رو توی اسم نمایشی یا بیوی قابل‌مشاهده حساب‌ها پیدا کنه.
