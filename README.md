...
&rlm;فیدبان نگهبان فیدته و کمک می‌کنه فید X (توییتر) رو پاکیزه کنی! کافیه یه ایموجی یا عبارت بهش بدی تا اون رو توی اسم نمایشی یا بیوی قابل‌مشاهده حساب‌ها پیدا کنه.
...
&rlm;![بخش‌های مختلف پنل فارسی فیدبان](./assets/feedban-controls-fa-2.png)
